...
function Register() {
    ...
    const handleVerifyOTP = async (e) => {
        ...
        try {
            ...
            setOtpError(err.response?.data?.msg || 'OTP verification failed');
        } finally {
            setOtpLoading(false);
        }
    };
                ...
                <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
                    ...
                    <div className="bg-slate-950 px-8 py-12 text-center relative overflow-hidden">
                        ...
                        <p className="text-slate-400">
                            {step === 'register' ? 'Create your CivicConnect account' : 'Enter the OTP sent to your email'}
                        </p>
                    </div>
                    ...
                    {step === 'verify-otp' && (
                        <>
                            <form onSubmit={handleVerifyOTP} className="px-8 py-8 space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full border-2 border-slate-200 rounded-lg px-4 py-3 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-200 transition text-center text-2xl tracking-widest"
                                        required
                                    />
                                </div>
                                ...
                                <div className="text-center">
                                    <p className="text-sm text-slate-600 mb-2">Didn't receive OTP?</p>
                                    <button
                                        type="button"
                                        onClick={handleResendOTP}
                                        disabled={otpLoading}
                                        className="text-orange-600 hover:text-orange-700 font-semibold text-sm disabled:opacity-50"
                                    >
                                        Resend OTP
                                    </button>
                                </div>
                                ...
                                <button
                                    ...
                                    className="w-full border-2 border-slate-200 text-slate-700 py-2 rounded-lg hover:bg-slate-50 transition duration-200 text-sm font-semibold"
                                >
